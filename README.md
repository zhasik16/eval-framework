...
--concurrency — parallel executions (keep low on free tier)
--repeats — detect flaky behavior
...
Test cases are defined in YAML under test_cases/.
...
LLM judge not perfectly reliable
Cross-platform issues with symlinks (handled via fallback)
🔮 Future Improvements
Statistical significance testing for flaky cases
